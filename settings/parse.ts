    ...
    users: [
        {
            ...
            pass: process.env.PARSE_DASHBOARD_PASSWORD || '$2y$12$qJNCnZJbWwic65hfajh3UO7eKZyWw4gvjF6.O3TwxH7rzAbkroLA2', //  admin@lime2021
        }
    ],
...
export const PARSE_DASHBOARD_OPTIONS = {
    allowInsecureHTTP: process.env.PARSE_DASHBOARD_INSECURE_HTTP === 'false' ? false : true,
    cookieSessionSecret: process.env.PARSE_DASHBOARD_COOKIE_SESSION_SECRET || 'myCookieSessionSecret'
}
